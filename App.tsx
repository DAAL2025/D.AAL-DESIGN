...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-black font-sans selection:bg-gold/30 selection:text-gold selection:opacity-100">
      ...
      <Hero />
      <main>
        {/* About Section: Refined Visual Rhythm */}
        <section id="about" className="py-40 md:py-64 bg-black relative overflow-hidden spotlight-bg">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-40 bg-gradient-to-b from-gold/20 to-transparent"></div>
          
          <div className="max-w-7xl mx-auto px-8 text-center flex flex-col items-center">
            <div className="mb-20 md:mb-36 flex flex-col items-center">
               <span className="text-[10px] md:text-[11px] text-gold/80 mb-4 font-semibold tracking-[0.3em]">우리의 태도</span>
            ...
            <div className="max-w-4xl mx-auto mb-20 md:mb-32">
              <h2 className="text-[24px] md:text-[44px] lg:text-[54px] font-serif text-white/95 leading-[1.5] tracking-tighter text-balance">
            ...
            <div className="max-w-2xl mx-auto">
              <p className="text-grayText/40 text-[15px] md:text-[19px] font-light leading-[2] md:leading-[2.4] tracking-normal px-4">
              ...
              <div className="pt-24 md:pt-36">
                 <div className="inline-flex flex-col items-center opacity-30">
                    <div className="w-20 h-px bg-gold/50 mb-6"></div>
