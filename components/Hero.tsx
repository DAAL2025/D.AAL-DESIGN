  ...
  return (
    <header className="relative h-screen flex items-center justify-center bg-black overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center px-6 w-full text-center">
        ...
        <div className="max-w-5xl mx-auto mb-14 md:mb-20 px-4">
          <h1 className="text-[32px] md:text-[56px] lg:text-[76px] font-serif font-normal text-white leading-[1.3] md:leading-[1.2] tracking-tighter animate-fade-in-up stagger-1 text-balance break-keep">
        ...
        <div className="max-w-2xl mx-auto mb-20 md:mb-28 opacity-0 animate-fade-in-up stagger-2 px-6">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 justify-center items-center opacity-0 animate-fade-in-up stagger-3">
          ...
          >
            <span className="flex flex-col items-center">
              ...
              <span className="tracking-[0.5em] text-[7px] uppercase opacity-20 group-hover:opacity-100 transition-opacity font-sans">Contact Us</span>
            </span>
          </button>
          ...
          >
            ...
            <span className="tracking-[0.6em] text-[7px] uppercase opacity-20 group-hover:opacity-100 transition-opacity font-sans">Archive</span>
          </button>
        </div>
      </div>
